...
test('Test Rating Generation', t => {
    ...
    userObj.findOne({ username: "glen.connolly" }).exec(function (err, user) {
        ...
        t.true(_rec._expr(_rec._capt(user, 'arguments/0'), {
            content: 't.true(user)',
            filepath: 'models\\attribute\\calculator.test.js',
            line: 10,
            ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"Identifier","name":"user","range":[7,11]}],"range":[0,12]}',
            tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"user","range":[7,11]},{"type":{"label":")"},"range":[11,12]}]',
            visitorKeys: _powerAssertVisitorKeys
        }));
        t.false(_rec2._expr(_rec2._capt(err, 'arguments/0'), {
            content: 't.false(err)',
            filepath: 'models\\attribute\\calculator.test.js',
            line: 11,
            ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"false","range":[2,7]},"computed":false,"range":[0,7]},"arguments":[{"type":"Identifier","name":"err","range":[8,11]}],"range":[0,12]}',
            tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"false"},"value":"false","range":[2,7]},{"type":{"label":"("},"range":[7,8]},{"type":{"label":"name"},"value":"err","range":[8,11]},{"type":{"label":")"},"range":[11,12]}]',
            visitorKeys: _powerAssertVisitorKeys
        }));
        activityUserObj.findOne({ userId: user._id }).exec(function (err, actUser) {
            ...
            t.true(_rec3._expr(_rec3._capt(actUser, 'arguments/0'), {
                content: 't.true(actUser)',
                filepath: 'models\\attribute\\calculator.test.js',
                line: 13,
                ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"Identifier","name":"actUser","range":[7,14]}],"range":[0,15]}',
                tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"actUser","range":[7,14]},{"type":{"label":")"},"range":[14,15]}]',
                visitorKeys: _powerAssertVisitorKeys
            }));
            t.false(_rec4._expr(_rec4._capt(err, 'arguments/0'), {
                content: 't.false(err)',
                filepath: 'models\\attribute\\calculator.test.js',
                line: 14,
                ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"false","range":[2,7]},"computed":false,"range":[0,7]},"arguments":[{"type":"Identifier","name":"err","range":[8,11]}],"range":[0,12]}',
            ...
            ratingObj.findOne({ actUserId: actUser._id, attrIndex: 0 }).exec(function (err, ratingObj) {
                ...
                t.true(_rec5._expr(_rec5._capt(ratingObj, 'arguments/0'), {
                    content: 't.true(ratingObj)',
                    filepath: 'models\\attribute\\calculator.test.js',
                    line: 16,
                    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"Identifier","name":"ratingObj","range":[7,16]}],"range":[0,17]}',
                    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"ratingObj","range":[7,16]},{"type":{"label":")"},"range":[16,17]}]',
                    visitorKeys: _powerAssertVisitorKeys
                }));
                t.false(_rec6._expr(_rec6._capt(err, 'arguments/0'), {
                    content: 't.false(err)',
                    filepath: 'models\\attribute\\calculator.test.js',
                    line: 17,
                    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"false","range":[2,7]},"computed":false,"range":[0,7]},"arguments":[{"type":"Identifier","name":"err","range":[8,11]}],"range":[0,12]}',
                ...
                calculator.generateUpdatedAttributeValue(ratingObj, function (err, newValue) {
                    ...
                    t.false(_rec7._expr(_rec7._capt(err, 'arguments/0'), {
                        content: 't.false(err)',
                        filepath: 'models\\attribute\\calculator.test.js',
                        line: 19,
                        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"false","range":[2,7]},"computed":false,"range":[0,7]},"arguments":[{"type":"Identifier","name":"err","range":[8,11]}],"range":[0,12]}',
...
//# sourceMappingURL=C:\Users\conno\Documents\Project\MoreOfUs\node_modules\.cache\ava\626f763ecc68013e48bd0a35d4c4310d.js.map